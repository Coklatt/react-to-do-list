            ...
            <MuiThemeProvider>
                <div className="App">
                    ...
                    <ConfirmDialog
                        ...
                        message={'Remove all tasks from the App?'}
                        onCancel={this.dialogCloseHandler}
                    ...
                    <div className="App-container">
                        ...
                        >
                            ...
                            />
                            <Tabs onChange={this.changeHandler} value={this.state.slideIndex}>
                        ...
                        >
                            ...
                            <div className="app-lists">
                                <SwipeableViews
                                    ...
                                    onChangeIndex={this.changeHandler}
                                    style={{ width: '100%' }}
                                >
                                    {columns.map((column, index) => (
